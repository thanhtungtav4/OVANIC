...
if ( ! class_exists( 'WPSEO_Video_Metabox' ) ) {
	...
	class WPSEO_Video_Metabox extends WPSEO_Metabox {
		...
		public function register_hooks() {
			...
			add_filter( 'wpseo_content_meta_section_content', array( $this, 'add_hidden_fields' ) );

			add_filter( 'wpseo_elementor_hidden_fields', array( $this, 'add_hidden_fields' ) );
		...
		private function localize_video_script() {
			...
			return array(
				...
				'shortlinks.configuration_guide' => WPSEO_Shortlinker::get( 'https://yoast.com/help/video-seo-plugin-configuration-guide/' ),
