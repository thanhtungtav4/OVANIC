...
class WPSEO_Video_Bootstrap {
	...
	protected function is_wordpress_up_to_date() {
		return version_compare( $GLOBALS['wp_version'], '5.6', '>=' );
	}
	...
	protected function is_yoast_seo_up_to_date() {
		// At least 17.8, in which a BC break in the JS was released.
		return $this->is_yoast_seo_active() && version_compare( WPSEO_VERSION, '17.8-RC0', '>=' );
	}
