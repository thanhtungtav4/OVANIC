...
$section1 = array(
	...
	'single_product_message'           => array(
		...
		'yith-type' => 'textarea',
		'type'      => 'yith-field',
		'default'   => __( 'If you purchase this product you will earn <strong>{points}</strong> {points_label} worth {price_discount_fixed_conversion}!', 'yith-woocommerce-points-and-rewards' ),
	...
	'loop_message'                     => array(
		...
		'yith-type' => 'textarea',
		'type'      => 'yith-field',
		'default'   => __( '<strong>{points}</strong> {points_label}', 'yith-woocommerce-points-and-rewards' ),
