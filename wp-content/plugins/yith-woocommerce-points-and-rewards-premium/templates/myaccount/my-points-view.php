...
<div class="ywpar-wrapper">
	<h2><?php echo wp_kses_post( apply_filters( 'ywpar_my_account_my_points_title', sprintf( __( 'My %s', 'yith-woocommerce-points-and-rewards' ), $plural ) ) ); ?></h2>

	<p>
		<?php
		$points  = sprintf( _n( '<strong>%1$s</strong> %2$s', '<strong>%3$s</strong> %4$s', $points, 'yith-woocommerce-points-and-rewards' ), $points, $singular, $points, $plural );
	...
	<h3><?php echo wp_kses_post( apply_filters( 'ywpar_my_account_my_points_history_title', sprintf( __( 'My %s History', 'yith-woocommerce-points-and-rewards' ), $singular ) ) ); ?></h3>
