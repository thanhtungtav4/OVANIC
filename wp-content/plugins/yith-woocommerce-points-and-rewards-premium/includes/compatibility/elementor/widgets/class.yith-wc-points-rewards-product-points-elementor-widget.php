	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => __( '{points} number of points earned;<br>{points_label} label of points;<br>{price_discount_fixed_conversion} the value corresponding to points ', 'yith-woocommerce-points-and-rewards' ),
