	...
	class YWPAR_Subscription {
		...
		public function assign_points_on_renew( $subscription, $order ) {
			...
			if ( $point_earned > 0 ) {
				...
				$order->add_order_note( sprintf( __( 'Customer earned %1$d %2$s for this purchase.', 'yith-woocommerce-points-and-rewards' ), $point_earned, YITH_WC_Points_Rewards()->get_option( 'points_label_plural' ) ), 0 );
