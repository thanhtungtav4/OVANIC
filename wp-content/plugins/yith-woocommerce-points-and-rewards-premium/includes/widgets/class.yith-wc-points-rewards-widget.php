...
if ( ! class_exists( 'YITH_YWPAR_Points_Rewards_Widget' ) ) {
	...
	class YITH_YWPAR_Points_Rewards_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			printf( wp_kses_post( _n( '<strong>%1$s</strong> %2$s', '<strong>%3$s</strong> %4$s', $points, 'yith-woocommerce-points-and-rewards' ) ), esc_html( $points ), esc_html( $singular ), esc_html( $points ), esc_html( $plural ) );
			echo '</p>';
