		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'subject'           => array(
					...
					'type'        => 'text',
					'description' => sprintf( __( 'This field lets you edit the email subject line. Leave it blank to use the default subject text: <code>%s</code>.', 'yith-woocommerce-points-and-rewards' ), $this->subject ),
					'placeholder' => '',
					'default'     => '',
				),
				'recipient'         => array(
				...
				'heading'           => array(
					...
					'type'        => 'text',
					'description' => sprintf( __( 'This field lets you change the main heading in email notification. Leave it blank to use the default heading type: <code>%s</code>.', 'yith-woocommerce-points-and-rewards' ), $this->heading ),
					'placeholder' => '',
					'default'     => '',
				),
