...
if(!class_exists('devvn_reviews_auto_update')) {
    ...
    function devvn_devvn_reviews_auto_update()
    {
        ...
        $license_key = isset($devvn_review_settings['license_key']) ? sanitize_text_field($devvn_review_settings['license_key']) : '';
        $devvn_plugin_current_version = DEVVN_REVIEWS_VERSION_NUM;
        $devvn_plugin_remote_path = 'http://license.levantoan.com/wp-admin/admin-ajax.php?action=devvn_update&slug=devvn-woocommerce-reviews&getremote=update&license='.$license_key;
