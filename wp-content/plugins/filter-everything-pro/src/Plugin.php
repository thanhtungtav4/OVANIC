...
class Plugin
{
    ...
    public function includeAdminJs()
    {
        ...
        wp_enqueue_script('wpc-filters-admin', FLRT_PLUGIN_URL . 'assets/js/wpc-filters-common-admin' . $suffix . '.js', array('jquery', 'jquery-ui-sortable', 'wp-color-picker', 'select2'), $ver );
