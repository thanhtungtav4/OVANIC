<?php
// [blog_posts]
function shortcode_latest_from_blog_flatsome_utils($atts, $content = null, $tag = '' ) {
...
add_shortcode("blog_posts_flatsome_utils", "shortcode_latest_from_blog_flatsome_utils");
