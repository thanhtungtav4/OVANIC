...
function ux_product_categories_flatsome_utils($atts, $content = null, $tag = '' ) {
  $sliderrandomid = rand();
  extract( shortcode_atts( array (
    ...
    // get terms and workaround WP bug with parents/pad counts
      $args = array(
        'orderby'    => $orderby,
        'order'      => $order,
        'hide_empty' => $fu_cat_hide_empty == 'true' ? false : true,
        'include'    => $ids,
        'pad_counts' => true,
        'child_of'   => 0,
        'offset' => $offset,
...
add_shortcode("ux_product_categories_flatsome_utils", "ux_product_categories_flatsome_utils");
