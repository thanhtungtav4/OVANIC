	...
	class YITH_WFBT_Frontend {
		...
		public function register_scripts() {
			...
			if( ! defined( 'YITH_PROTEO_VERSION' ) ) {
				...
				wp_register_style( 'yith-wfbt-query-dialog-style', $style );
				wp_register_script( 'yith-wfbt-query-dialog', $script, array( 'jquery' ), false, true );
			}
		...
		public function add_bought_together_form( $product_id = false ) {
            ...
            $discount = ! empty( $original_product ) ? floatval( $this->discount->get_discount_amount( $original_product, $products, null, $total ) ) : floatval( $this->discount->get_discount_amount( $product, $products, null, $total ) );
