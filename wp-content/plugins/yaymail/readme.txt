...
**Powerful Shortcodes**
You have a variety of placeholders for order details, customer details, billing info, shipping, payment, new user info, additional order metadata, etc. Literally, everything you need to establish a strong brand impression!
...
You can fine-tune the design of WooCommerce email templates globally or individually with custom CSS and add extra content:
...
This WooCommerce email designer's third-party integrations are including but not limited to:
...
- Improved: Performance for EDD (Pro) 
...
= Jul 22, 2021 - Version 2.1.6 =
- Supported: Custom Order Status for WooCommerce (Pro version)
...
- Fixed: Support Flexible Checkout field plugin by WPDesk (Pro version)
...
- Fixed: Addon conflict
- Fixed: Prevent translate state and country by WooCommerce
- Fixed: Template duplicate function
- Fixed: Some issues with Flexible Checkout Field plugin
- Fixed: XSS warning by Wordfence

= Jun 11, 2021 – Version 2.0.8 =
- Improved: Something

= Jun 9, 2021 – Version 2.0.7 =
- Support: YITH Membership (YayMail Premium Addon)
- Fixed: Shortcode yaymail_user_account_url_string
- Fixed: Support WPML / Polylang (PRO)
- Fixed: Small bugs

= Jun 1, 2021 – Version 2.0.6 =
- Supported: order_meta
- Fixed: The log.txt issue
- Fixed: Shorcode yaymail_user_id

= May 18, 2021 – Version 2.0.5 =
- Support: YITH Booking (YayMail Premium Addon)
- Support: WooCommerce Deposits (YayMail Premium Addon)
- Support: Spark Mail App
- Fixed: Reset password email template

= May 13, 2021 – Version 2.0.4 =
- Support: B2B & Wholesale Suite (YayMail Premium Addon)
- Support: Dokan (YayMail Premium Addon)

= May 07, 2021 – Version 2.0.3 =
- Support: Back In Stock Notifier for WooCommerce (PRO)
- Support: WPML / Polylang (PRO)
- Support: Smart Coupons by StoreApps (YayMail Premium Addon)
...
- Added: Support Woocommerce Bookings (YayMail Premium Addon)
- Added: Support Germanized PRO Plugin (YayMail Premium Addon)
- Added: Support YITH Wishlist "Ask for Estimate" template (Addon)
...
- Added: Support YITH Woocommerce Multi Vendor Premium plugin (YayMail Premium Addon)
