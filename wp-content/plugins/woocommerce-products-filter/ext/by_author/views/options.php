...
<li data-key="<?php esc_attr_e($key) ?>" class="woof_options_li">
    ...
    <a href="#" data-key="<?php esc_attr_e($key) ?>" data-name="<?php esc_html_e("Search by Author", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php esc_attr_e($key) ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
    ...
    <input type="hidden" name="woof_settings[<?php esc_attr_e($key) ?>][placeholder]" value="<?php echo wp_kses_post(wp_unslash($woof_settings[$key]['placeholder'])) ?>" />
    <input type="hidden" name="woof_settings[<?php esc_attr_e($key) ?>][role]" value="<?php esc_html_e($woof_settings[$key]['role']) ?>" />
    <input type="hidden" name="woof_settings[<?php esc_attr_e($key) ?>][view]" value="<?php esc_html_e($woof_settings[$key]['view']) ?>" />

    <div id="woof-modal-content-<?php esc_html_e($key) ?>" style="display: none;">
