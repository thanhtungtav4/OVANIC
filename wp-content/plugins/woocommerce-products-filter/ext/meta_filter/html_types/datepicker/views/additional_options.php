...
<input type="hidden" name="woof_settings[<?php esc_attr_e($key) ?>][format]" value="<?php echo wp_kses_post(wp_unslash(isset($settings[$key]['format']) ? stripcslashes($settings[$key]['format']) : 'mm/dd/yy')) ?>" />
