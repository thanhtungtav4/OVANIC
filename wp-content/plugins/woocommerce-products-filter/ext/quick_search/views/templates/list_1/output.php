...
?><div class="woof_qs_result  woof_qs_table_<?php esc_attr_e($template_result) ?>  text_res_page_0 "> 
    ...
    <table style="width: 100%;" cellspacing="0" class="woof_qs_container">
        <tr>
            <?php foreach ($structure as $item): ?>
                <th class="<?php esc_attr_e($item['class']) ?>"><?php esc_html_e($item['title']) ?>
                    <?php
                    if ($item['key'] == 'price') {
        ...
        <tr class="woof_qs_item">
            ...
            foreach ($structure as $item):
                ...
                if ($item['key'] == 'img') {
                    ?>
                    <td class="woof_qs_<?php esc_attr_e($template_result) ?>_<?php esc_attr_e($item['key']) ?>_col">
        ...
        <tr class="woof_qs_no_products_item">
            <td colspan='10' class='woof_qs_no_products woof_qs_no_products_<?php esc_attr_e($template_result) ?>'><?php esc_html_e('Product not found', 'woocommerce-products-filter') ?></td>
        </tr>
    </table>
    __PAGINATION__
</div>
