                ...
                <div class="card__content">
                    ...
                    foreach ($structure as $item):
                        if ($item['key'] == 'img') {
                            ...
                            ?>
                            <div class="woof_qs_<?php esc_attr_e($template_result) ?>_<?php esc_attr_e($item['key']) ?> card__title" >
                                <a href="__URL__" target="__TARGET__">__TITLE__</a>
                            </div>
                            <?php
                        } else {
                            ?>
                            <p class="woof_qs_<?php esc_attr_e($template_result) ?>_<?php esc_attr_e($item['key']) ?>">
