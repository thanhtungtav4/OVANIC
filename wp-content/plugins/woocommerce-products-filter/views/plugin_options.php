                                    ...
                                    <?php if (isset($this->settings['custom_extensions_path']) AND!empty($this->settings['custom_extensions_path'])): ?>
                                        ...
                                        <div class="woof-section-title">
                                            <div class="col-title">
                                                ...
                                                <h4><?php esc_html_e('Custom extensions installation', 'woocommerce-products-filter') ?></h4>
                                            ...
                                            <div class="col-button">
                                                ...
                                                if ($is_custom_extensions):
                                                    ?>
                                                    <input type="button" id="upload-btn" class="button woof-button-outline-secondary" value="<?php esc_html_e('Choose an extension zip', 'woocommerce-products-filter') ?>">
                        ...
                        <div class="woof-row">
                            ...
                            <div class="woof-col-lg-6 woof-mt-4">
                                <div class="woof-d-flex woof-p-4 woof-shadow woof-align-items-center woof-features woof-rounded">
                                    ...
                                    <div class="woof-ms-4">
                                        <h5 class="woof-h5 woof-mb-1">
                                            <a class="woof-text-dark" href="https://pluginus.net/support/forum/woof-woocommerce-products-filter/" target="_blank"><?php esc_html_e("WooCommerce Products Filter Support", 'woocommerce-products-filter') ?></a>
                                        </h5>
                                    </div>
                                </div>
                            </div>
